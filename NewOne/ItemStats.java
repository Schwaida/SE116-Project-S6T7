...
public interface ItemStats {
    ...
    String ironSmallAxe="iron small axe";
    ...
    String ironBroadAxe= "iron broad axe";
    ...
    String bronzeSmallAxe= "bronze small Axe";
    ...
    String bronzeBroadAxe= "bronze broad axe";
    ...
    String steelSmallAxe = "steel small axe";
    ...
    String ironShortSword= "iron short sword";
    ...
    String ironLongSword= "iron long sword";
    ...
    String bronzeDagger= "bronze dagger";
    ...
    String bronzeShortSword= "bronze short sword";
    ...
    String bronzeLongSword= "bronze long sword";
    ...
    String steelDagger= "steel dagger";
    ...
    String steelShortSword= "steel short sword";
    ...
    String steelLongSword= "steel long sword";
    ...
    String compositeBow= "composite bow";
    ...
    String lightClothing="light clothing" ;
