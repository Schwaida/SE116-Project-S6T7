...
public class Game extends Texts implements ItemStats {
    ...
    public static void command(Hero hero) {
        ...
        switch (playerInput) {
            ...
            case "quit" -> System.out.println("You left the game, see you soon!!");
            default -> System.out.println("Invalid command! Check info");
        }
    ...
    public static void showRoom(Rooms currentRoom, Rooms lastRoom, String direction) {
        ...
        if (currentRoom != lastRoom) {
            ...
            if (Rooms.getDroppedItem()!= null && !Rooms.getDroppedItem().isEmpty()&&currentRoom.getMonsters()!=null&& Map.currentRoom.getDroppedInfo()!=null) {
...
public static void showInfo() {
    ...
    WeightSystem weightSystem = new WeightSystem();
        ...
        weightSystem.system();
        System.out.println("CURRENT WEIGHT: "+weightSystem.getWeight());
