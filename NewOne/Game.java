...
public class Game implements ItemStats {
    ...
    public static void levels(Rooms currentRoom) {
        ...
        if (currentRoom.isStairRoom()) {
            if (a == 1) {
                System.out.println("Do you want to go upper level? If so press (1)");
                ...
                System.out.println("You want to go lower (2) level? If so press (2)");
                levelChoice = scanner.nextInt();
                scanner.nextLine();
                if (levelChoice == 2) {
                    a--;
                ...
                System.out.println("If you want to go upper level press (1), lower level press (2) ?");
                levelChoice = scanner.nextInt();
                scanner.nextLine();
                if (levelChoice == 1) {
                    a++;
    ...
    public static void printAttacks(Rooms currentRoom) {
        ...
        System.out.println("What are you going to do : (1) Attack" + monster.getName() + " (2) Run ");
            ...
            if (input == 1) {
                while (!monster.isDead() && !hero.isDead()) {
                    ...
                    if (monster.isDead()) {
                        ...
                        if (monster.getMonsterInventory() != null) {
                            try {
                                System.out.print("It dropped " + (monster.getMonsterInventory().get(0).toUpperCase().toString() + " !")); // her monster için olmayacak
                                ...
                                if (a == 1) {
                                    ...
                                    monster.addMonsterInventory(monster.getMonsterInventory().get(0));
                                    Rooms.getDroppedItem().add(monster.getMonsterInventory().get(0));
                    ...
                    } else if (hero.getHitPoint() <= 0) {// ölme olayı burada oluyor      --> artık olmuyor
                ...
                System.out.println("Lucky you, you managed to reach the doors before the " + monster.getName()+" see you");
